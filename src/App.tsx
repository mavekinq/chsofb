...
import Tav2FlightsPage from "./pages/Tav2FlightsPage.tsx";
import TeslimPage from "./pages/TeslimPage.tsx";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/tav2" element={<Tav2FlightsPage />} />
          <Route path="/teslim" element={<TeslimPage />} />
